...
- (AnyPromise *)currenciesExchangeRatesFromDictionary:(NSDictionary *)dict {
    return [AnyPromise promiseWithResolverBlock:^(PMKResolver  _Nonnull resolve) {
        //NSLog([FEMDeserializer objectFromRepresentation:dict mapping:[Mapping exchangeMapping]]);
        //resolve([FEMDeserializer objectFromRepresentation:dict mapping:[Mapping exchangeMapping]]);
...
//        [dict enumerateObjectsUsingBlock:^(NSDictionary * _Nonnull exchangeInfo, NSUInteger idx, BOOL * _Nonnull stop) {
//            [exchangeRates addObject:[FEMDeserializer objectFromRepresentation:exchangeInfo
//                                                                                           mapping:[Mapping exchangeMapping]]];
//        }];
        NSLog(exchangeRates);
